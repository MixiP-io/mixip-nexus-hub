...
describe('Cover Image Operations', () => {
      ...
      projects: [
        {
          ...
          name: 'Test Project',
          assets: [
            { id: 'asset1', name: 'Asset 1', type: 'image/jpeg', preview: 'data:image/jpeg;base64,test', size: 1000, uploadedAt: new Date(), licenseType: 'standard' }
          ],
          updatedAt: new Date()
        },
        {
          ...
          assets: [
            { id: 'asset2', name: 'Asset 2', type: 'image/png', preview: 'data:image/png;base64,test', size: 1000, uploadedAt: new Date(), licenseType: 'standard' }
          ],
  ...
  describe('updateProjectCoverIfNeeded', () => {
    it('should update cover image if project does not have one', () => {
      ...
      const assets = [
        { id: 'asset1', name: 'Test Image', type: 'image/jpeg', preview: 'data:image/jpeg;base64,test', size: 1000, uploadedAt: new Date(), licenseType: 'standard' }
      ];
    ...
    it('should not update cover image if project already has one', () => {
      ...
      const assets = [
        { id: 'asset2', name: 'Test Image', type: 'image/jpeg', preview: 'data:image/jpeg;base64,new', size: 1000, uploadedAt: new Date(), licenseType: 'standard' }
      ];
    ...
    it('should not update cover if no image assets with preview are found', () => {
      ...
      const projectIndex = 0; // Project without cover image
      const assets = [
        { id: 'asset1', name: 'Text File', type: 'text/plain', preview: null, size: 1000, uploadedAt: new Date(), licenseType: 'standard' }
      ];
